...
from storage import guilds as guilds_db,j2c_settings as j2c_settings_db,guilds_log as guilds_log_db,antinuke_settings as antinuke_settings_db,welcomer_settings as welcomer_settings_db
...
class More(commands.Cog):
    ...
    async def customrole_remove(self,ctx:commands.Context,name:str):
        try:
            ...
            await storage.custom_roles.delete(
                guild_id=ctx.guild.id,
                name=name
            )
            await ctx.send(embed=discord.Embed(
    ...
    async def customrole_reqrole(self,ctx:commands.Context):
        try:
            ...
            if not role:
                await storage.custom_roles_permissions.delete(
                    guild_id=ctx.guild.id
                )
                return await ctx.send(embed=discord.Embed(
    ...
    async def autoresponder_remove(self,ctx:commands.Context,*,keyword:str):
        try:
            ...
            await storage.auto_responder.delete(
                guild_id=ctx.guild.id,
                keyword=keyword
            )
            await ctx.send(embed=discord.Embed(
    ...
    async def JoinToCreateVC_Module(self,ctx:commands.Context):
        try:
            ...
            async def get_embed():
                ...
                vc_category_text = f"<#{vc_category_id}>" if vc_category_id else "Not Set"
                embed.add_field(
...
**__Settings type:__** `{cache_antinuke_settings.get('type')}`
\n"""
                                    selected_limit = cache_antinuke_settings.get(f"{selected_module}_limit")
                                    selected_punishment = cache_antinuke_settings.get(f"{selected_module}_punishment")
                    ...
                    if value == "member_logs":
                        async def get_embed_and_view_member_logs():
                            ...
                            embed.add_field(
                                ...
                                value=format_logging_channel(cache_logging_settings, 'member_join_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.LEAVE} - Leave Log",
                                value=format_logging_channel(cache_logging_settings, 'member_leave_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name="",
                            ...
                            embed.add_field(
                                ...
                                value=format_logging_channel(cache_logging_settings, 'member_kick_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.BAN} - Ban Log",
                                value=format_logging_channel(cache_logging_settings, 'member_ban_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name="",
                            ...
                            embed.add_field(
                                ...
                                value=format_logging_channel(cache_logging_settings, 'member_unban_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.UPDATE} - Update Log",
                                value=format_logging_channel(cache_logging_settings, 'member_update_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_message_logs():
                            ...
                            embed.add_field(
                                ...
                                value=format_logging_channel(cache_logging_settings, 'message_delete_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.EDIT} - Edit Log",
                                value=format_logging_channel(cache_logging_settings, 'message_edit_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_channel_logs():
                            ...
                            embed.add_field(
                                ...
                                value=format_logging_channel(cache_logging_settings, 'channel_create_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.DELETE} - Delete Log",
                                value=format_logging_channel(cache_logging_settings, 'channel_delete_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name="",
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.UPDATE} - Update Log",
                                value=format_logging_channel(cache_logging_settings, 'channel_update_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_role_logs():
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.CREATE} - Create Log",
                                value=format_logging_channel(cache_logging_settings, 'role_create_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.DELETE} - Delete Log",
                                value=format_logging_channel(cache_logging_settings, 'role_delete_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name="",
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.UPDATE} - Update Log",
                                value=format_logging_channel(cache_logging_settings, 'role_update_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_emoji_logs():
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.CREATE} - Create Log",
                                value=format_logging_channel(cache_logging_settings, 'emoji_create_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.DELETE} - Delete Log",
                                value=format_logging_channel(cache_logging_settings, 'emoji_delete_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name="",
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.UPDATE} - Update Log",
                                value=format_logging_channel(cache_logging_settings, 'emoji_update_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_webhook_logs():
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.CREATE} - Create Log",
                                value=format_logging_channel(cache_logging_settings, 'webhook_create_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.DELETE} - Delete Log",
                                value=format_logging_channel(cache_logging_settings, 'webhook_delete_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name="",
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.UPDATE} - Update Log",
                                value=format_logging_channel(cache_logging_settings, 'webhook_update_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_invite_logs():
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.CREATE} - Create Log",
                                value=format_logging_channel(cache_logging_settings, 'invite_create_channel_id'),
                                inline=True
                            )
                            embed.add_field(
                                name=f"{self.bot.emoji.DELETE} - Delete Log",
                                value=format_logging_channel(cache_logging_settings, 'invite_delete_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_guild_logs():
                            ...
                            embed.add_field(
                                name=f"{self.bot.emoji.UPDATE} - Update Log",
                                value=format_logging_channel(cache_logging_settings, 'guild_update_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_voice_logs():
                            ...
                            embed.add_field(
                                ...
                                value=format_logging_channel(cache_logging_settings, 'voice_state_update_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
                        ...
                        async def get_embed_and_view_antinue_logs():
                            ...
                            embed.add_field(
                                ...
                                value=format_logging_channel(cache_logging_settings, 'antinuke_channel_id'),
                                inline=True
                            )
                            embed.set_footer(
    ...
    async def reset(self,ctx:commands.Context):
        try:
            ...
            embed.set_footer(text=f"REO • CodeX Development",icon_url=self.bot.user.display_avatar.url)
            await ctx.send(embed=embed)
